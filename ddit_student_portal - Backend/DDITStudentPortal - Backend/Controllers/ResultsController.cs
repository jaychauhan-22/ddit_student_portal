...
namespace DDITStudentPortal.Controllers
{
    ...
    public class ResultsController : ControllerBase
    {
        ...
        public ResultsController(DDITStudentPortalContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Results/5
        [HttpGet("{id}")]
        public async Task<ActionResult<IEnumerable<Result>>> GetResult(int id)
        {
            var result = await _context.Result.Where(x=>x.SessionNo == id).ToListAsync();
